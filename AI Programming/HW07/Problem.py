...
class Problem():
    ...
    def setVaraible(self):  
        print('Overriding SetVariable Function')
...
class Numeric(Problem):
    ...
    def report(self):
        ...
        print(self.coordinate(self._solution))  # Convert list to tuple , current
        print("Minimum value: {0:,.3f}".format(self._minimum)) # valueC
        print()
